...
const PackageSection = () => {
  const packages = [
    ...
    },
    {
      ...
      icon: <Waves className="w-12 h-12 text-ocean mb-4" />,
    ...
    <section id="packages" className="section-padding polynesian-pattern">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="inline-block px-3 py-1 bg-ocean/10 text-ocean rounded-full text-sm font-medium mb-4">Our Specialties</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {packages.map((pkg, index) => (
            ...
            >
              ...
              <button className="neomorphic-btn mt-auto text-ocean hover:text-ocean-dark">
                Learn More
              </button>
            </div>
          ))}
